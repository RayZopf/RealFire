// LSL script generated: RealFire-Rene10957.LSL.P-Anim.lslp Fri Feb  7 21:06:26 Mitteleuropäische Zeit 2014
///////////////////////////////////////////////////////////////////////////////////////////////////
...
InfoLines(integer bool){
    if ((g_iVerbose && bool)) {
        if (g_iPrimFireAvail) llWhisper(0,(("(v) " + g_sTitle) + " - File(s) found in inventory: Yes"));
